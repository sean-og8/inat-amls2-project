...
model =  EfficientNet_ContextualData(n_classes=1486, contextual_dim=3, tune_all_layers=True)                 # Build model object.
...
print('TA:{train_metrics},{};'.format(train_acc, test_acc))
